    ...
    <section className="max-w-screen-xl mx-auto px-4 relative pb-8 sm:pb-16">
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-8 sm:gap-[80px] items-center sm:mt-20 relative">
        ...
        <div className="w-full cardright">
          ...
          <p className="text-justify text-sm md:text-base mt-2 text-white">
            ...
            efficiently. It allows Human Resource (HR) departments and managers
            to maintain records of employees, track attendance, manage salaries,
            evaluate performance, assign roles, and handle leave requests. EMS
            improves overall workflow, reduces paperwork, and ensures better
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative ">
        <div className="order-2 sm:order-1 w-full card1">
          ...
          <p className="text-justify text-sm md:text-base mt-2 text-white">
            Saladify is an online platform dedicated to healthy eating and fresh
            salads. Users can explore a variety of salad recipes, learn about
            nutritional benefits, and order ready-to-eat salads or ingredients
            online. Saladify connects local farms, chefs, and customers through
            a digital marketplace, promoting healthy lifestyles and sustainable
            food choices.
          </p>
          <ul className="flex flex-wrap gap-2 mt-2">
            {[
        ...
        <a
          href="https://food-web-site-48in.vercel.app/"
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-8 sm:gap-[80px] items-center sm:mt-20 relative">
        ...
        <div className="w-full card4">
          <h3 className="text-blue-700 font-bold text-2xl md:text-4xl">
            Project Uploader — Full Stack Project{" "}
          </h3>
          <span className="text-blue-400 text-base md:text-lg m-0.5">
            Frontend (user interface) Backend (server, database)
          </span>
          <p className="text-justify text-sm md:text-base mt-2 text-yellow-400">
            Project Uploader is a full-stack web application that allows users
            to upload, store, and showcase their projects. The platform provides
            a user-friendly interface to submit project details such as the
            title, description, and files (images, PDFs, etc.). It is designed
            for developers, students, or teams to manage and share their project
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
        <div className="order-2 sm:order-1 w-full  card5">
          <h3 className="text-orange-300 font-bold text-2xl md:text-4xl m-1.5">
            Swiggy{" "}
          </h3>
          <span className="text-orange-300 text-base md:text-lg m-1.5">
            {" "}
            ("Your favorite food, delivered fast!" 🍔)
          </span>
          <p className="text-justify text-sm md:text-base mt-2 text-white">
            Swiggy is an online food delivery platform that connects users with
            a wide range of restaurants in their area. Users can browse menus,
            place orders, and get food delivered to their doorstep quickly and
            conveniently. Swiggy also offers real-time order tracking, multiple
            payment options, and customer support to ensure a smooth ordering
            experience.
          </p>
          <ul className="flex flex-wrap gap-2 mt-2">
            {[
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-8 sm:gap-[80px] items-center sm:mt-20 relative">
        ...
        <div className="w-full  card8">
          ...
          <span className="text-white text-base md:text-lg m-0.5">
            ( Your smart partner for everyday tasks!)
          </span>
          <p className="text-justify text-sm md:text-base mt-2 text-yellow-400">
            Make is a creative platform designed to help users build, design,
            and organize their ideas into real projects. Whether it's creating a
            to-do list, designing a product, or managing a team task, Make
            offers easy-to-use tools for planning, tracking, and completing
      ...
      <div className="flex flex-col sm:flex-row gap-4 mt-12 sm:gap-[80px] items-center sm:mt-20 relative">
        <div className="order-2 sm:order-1 w-full  card9">
          ...
          <span className="text-purple-400  text-base md:text-lg m-1.5">
            ( "Roll the dice, climb the ladder, and avoid the snakes!" 🐍🎲🪜)
          </span>
          <p className="text-justify text-sm md:text-base mt-2 text-white">
            Snake and Ladder is a classic board game recreated as a fun and
            interactive digital project. The game is played between two or more
            players who roll a dice and move forward on a board with 100
            numbered squares. If a player lands on the bottom of a ladder, they
            climb up. If they land on the head of a snake, they slide down. This
            project brings the traditional game to life with smooth animations,
            colorful graphics, and engaging gameplay. It's perfect for
            practicing logic, turn-based game development, and random number
            generation.
          </p>
          <ul className="flex flex-wrap gap-2 mt-2">
            {[
